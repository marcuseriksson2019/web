...
@NgModule({
    imports: [SourceModule, FormsModule, CommonModule, ReactiveFormsModule, BrowserModule, HttpClientModule, JsonpModule, HttpModule, 
    ...
    providers: [UserRegistration, UserLoginService, Logo, CartPreview, Search, SearchResults, SearchModel, NavigationBar, JsonpModule, SecureUrl, HttpModule, Home, Shop, Cart, ProductDetails, PlacedOrder, CartModel],
