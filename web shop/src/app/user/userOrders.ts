...
export class UserOrders { 
    ...
    constructor(private router: Router, private accounts: Accounts, private orderstack: Orderstack, private reviewstack: Reviewstack, private activeroute: ActivatedRoute) {
        ...
        this.user = this.accounts.getCurrentUser(); 
    }
    
    getOrders(): Order[] {
        return this.orderstack.getOrders().filter(o => o.email == this.getUser().email);
    }
    ...
    getUser() {
        return this.accounts.getCurrentUser();
    } 
